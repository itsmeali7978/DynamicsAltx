...
const APP_PAGES = [
    ...
    { path: 'voucher-entries.html', label: 'Voucher Entries' },
    { path: 'misc-income.html', label: 'Miscellaneous Income' },
    { path: 'misc-income-entries.html', label: 'Miscellaneous Income Entries' },
